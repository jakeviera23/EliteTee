...
export function DiscoverFiltersBar({
  ...
  const [desktopFiltersOpen, setDesktopFiltersOpen] = useState(activeCount > 0);
  ...
  return (
    <div className="et-discover-filters">
      <div className="et-discover-filters-primary">
        ...
        <button
          type="button"
          className="et-btn et-btn--secondary et-discover-filters-toggle"
      ...
      <div
        className={`et-discover-filters-desktop${desktopFiltersOpen ? " is-open" : ""}`}
      >
        <FilterSelect
          label="Location"
        ...
        <button
          type="button"
          className="et-btn et-btn--ghost et-discover-filters-collapse"
