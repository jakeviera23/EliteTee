          ...
          messages: [
            {
              ...
              content: [
                ...
                "answer must be plain text only: no Markdown, no bold/italic markers, no bullet lists, no raw JSON, arrays, or profile dumps.",
                "Keep answers concise (1-2 short sentences). Cards already show member and course details, so do not repeat card content at length.",
                "Distinguish logged rounds from member experiences/reviews. If no members have a logged round but course stats show experiences, say that clearly and never claim nobody has played the course.",
                "For ranked courses, one short sentence listing course names and ratings is enough.",
